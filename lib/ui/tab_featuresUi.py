...
#
# Created: Tue Nov 26 19:44:24 2013
...
class Ui_tab_features(object):
    def setupUi(self, tab_features):
        ...
        self.verticalLayout.setContentsMargins(2, 0, -1, -1)
        ...
        self.layout_feature_parameters.addWidget(self.lbl_min_area, 4, 0, 1, 1)
        ...
        self.layout_feature_parameters.addItem(spacerItem2, 0, 5, 1, 1)
        ...
        self.layout_feature_parameters.addWidget(self.btn_pick_color, 5, 0, 1, 4)
