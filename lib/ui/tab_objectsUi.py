...
class Ui_tab_objects(object):
    def setupUi(self, tab_objects):
        ...
        self.page_objects_tracking.setGeometry(QtCore.QRect(0, 0, 259, 322))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.table_slots.sizePolicy().hasHeightForWidth())
        self.table_slots.setSizePolicy(sizePolicy)
        ...
        self.table_slots.horizontalHeader().setDefaultSectionSize(75)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_lock_table.sizePolicy().hasHeightForWidth())
        self.btn_lock_table.setSizePolicy(sizePolicy)
        ...
        self.page_objects_IO.setGeometry(QtCore.QRect(0, 0, 259, 322))
