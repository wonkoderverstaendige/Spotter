...
class Ui_tab_regions(object):
    def setupUi(self, tab_regions):
        ...
        self.gridLayout_5.addWidget(self.tree_region_shapes, 5, 1, 2, 3)
        ...
        self.gridLayout_5.addLayout(self.gridLayout_10, 12, 1, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.spin_shape_y, 0, 5, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lbl_y, 0, 4, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.spin_shape_x, 0, 3, 1, 1)
        self.gridLayout_5.addLayout(self.gridLayout_3, 0, 1, 1, 3)
        ...
        self.gridLayout_5.addWidget(self.btn_remove_shape, 9, 3, 1, 1)
        self.combo_new_shape = QtGui.QComboBox(self.page_regions_overview)
        self.combo_new_shape.setObjectName(_fromUtf8("combo_new_shape"))
        self.gridLayout_5.addWidget(self.combo_new_shape, 9, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.btn_add_shape, 9, 2, 1, 1)
