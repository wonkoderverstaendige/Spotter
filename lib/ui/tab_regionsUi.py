...
class Ui_tab_regions(object):
    def setupUi(self, tab_regions):
        ...
        self.page_regions_overview.setGeometry(QtCore.QRect(0, 0, 248, 343))
        ...
        self.horizontalLayout.addWidget(self.lbl_y)
        ...
        self.horizontalLayout.addWidget(self.spin_shape_y)
        ...
        self.page_regions_IO.setGeometry(QtCore.QRect(0, 0, 248, 343))
        ...
        self.gridLayout_9.addItem(spacerItem1, 3, 1, 2, 2)
