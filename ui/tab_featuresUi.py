...
class Ui_tab_features(object):
    def setupUi(self, tab_features):
        ...
        self.page_feature_detection.setGeometry(QtCore.QRect(0, 0, 217, 247))
        ...
        self.page_feature_restriction.setGeometry(QtCore.QRect(0, 0, 217, 247))
        ...
        self.page_feature_IO.setGeometry(QtCore.QRect(0, 0, 217, 247))
