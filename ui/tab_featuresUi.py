...
#
# Created: Sat Jan 26 03:00:40 2013
...
class Ui_tab_features(object):
    def setupUi(self, tab_features):
        ...
        self.layout_feature_parameters.addWidget(self.line_2, 0, 3, 7, 1)
        self.spin_area_min = QtGui.QSpinBox(self.page_feature_detection)
        self.spin_area_min.setObjectName(_fromUtf8("spin_area_min"))
        self.layout_feature_parameters.addWidget(self.spin_area_min, 5, 2, 1, 1)
        ...
        self.layout_feature_parameters.addWidget(self.lbl_min_area, 5, 0, 1, 2)
        ...
        self.page_feature_restriction.setGeometry(QtCore.QRect(0, 0, 217, 259))
        ...
        self.page_feature_IO.setGeometry(QtCore.QRect(0, 0, 217, 259))
