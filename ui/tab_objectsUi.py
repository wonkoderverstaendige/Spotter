...
class Ui_tab_objects(object):
    def setupUi(self, tab_objects):
        ...
        self.page_objects_tracking.setGeometry(QtCore.QRect(0, 0, 238, 259))
        ...
        self.gridLayout_5.addWidget(self.combo_Object, 3, 0, 1, 3)
        ...
        self.combo_analog_signal = QtGui.QComboBox(self.page_objects_tracking)
        self.combo_analog_signal.setEnabled(False)
        self.combo_analog_signal.setObjectName(_fromUtf8("combo_analog_signal"))
        self.combo_analog_signal.addItem(_fromUtf8(""))
        self.combo_analog_signal.setItemText(0, QtGui.QApplication.translate("tab_objects", "Position", None, QtGui.QApplication.UnicodeUTF8))
        self.combo_analog_signal.addItem(_fromUtf8(""))
        self.combo_analog_signal.setItemText(1, QtGui.QApplication.translate("tab_objects", "Speed", None, QtGui.QApplication.UnicodeUTF8))
        self.combo_analog_signal.addItem(_fromUtf8(""))
        self.combo_analog_signal.setItemText(2, QtGui.QApplication.translate("tab_objects", "Direction", None, QtGui.QApplication.UnicodeUTF8))
        self.gridLayout_5.addWidget(self.combo_analog_signal, 0, 1, 1, 2)
        ...
        self.page_objects_restriction.setGeometry(QtCore.QRect(0, 0, 238, 259))
        ...
        self.page_objects_IO.setGeometry(QtCore.QRect(0, 0, 238, 259))
