...
class Ui_tab_objects(object):
    def setupUi(self, tab_objects):
        ...
        self.gridLayout_5.addWidget(self.ckb_trace, 3, 0, 1, 1)
        ...
        self.tree_link_spi_dac.setMaximumSize(QtCore.QSize(16777215, 5))
        self.tree_link_spi_dac.setIndentation(0)
        self.tree_link_spi_dac.setObjectName(_fromUtf8("tree_link_spi_dac"))
        self.gridLayout_5.addWidget(self.tree_link_spi_dac, 5, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.dial_direction, 1, 3, 3, 1)
