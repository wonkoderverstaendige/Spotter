...
class Ui_tab_serial(object):
    def setupUi(self, tab_serial):
        ...
        self.page_serial_connection.setGeometry(QtCore.QRect(0, 0, 275, 272))
        ...
        self.verticalLayout_2.addWidget(self.combo_serialports)
        ...
        self.verticalLayout.addWidget(self.btn_serial_refresh)
        ...
        self.gridLayout_4.addWidget(self.lbl_rx, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_4, 4, 2, 1, 1)
        ...
        self.page_objects_IO.setGeometry(QtCore.QRect(0, 0, 275, 272))
    ...
    def retranslateUi(self, tab_serial):
        ...
        self.lbl_rx.setText(QtGui.QApplication.translate("tab_serial", "rx:", None, QtGui.QApplication.UnicodeUTF8))
        self.lbl_tx.setText(QtGui.QApplication.translate("tab_serial", "tx:", None, QtGui.QApplication.UnicodeUTF8))
