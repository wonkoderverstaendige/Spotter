...
#
# Created: Tue Jan 15 15:57:33 2013
...
class Ui_tab_regions(object):
    def setupUi(self, tab_regions):
        ...
        self.page_regions_overview.setGeometry(QtCore.QRect(0, 0, 290, 260))
        ...
        self.tree_regions = QtGui.QTreeWidget(self.page_regions_overview)
        self.tree_regions.setObjectName(_fromUtf8("tree_regions"))
        self.tree_regions.headerItem().setText(0, QtGui.QApplication.translate("tab_regions", "Shapes", None, QtGui.QApplication.UnicodeUTF8))
        self.gridLayout_5.addWidget(self.tree_regions, 2, 0, 1, 3)
        ...
        self.page_regions_conditions.setGeometry(QtCore.QRect(0, 0, 290, 260))
        ...
        self.page_regions_IO.setGeometry(QtCore.QRect(0, 0, 290, 260))
